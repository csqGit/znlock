...
#user-name,#user-password,#button-group{ padding: 5px 0;}
#button-group{
	margin-top:10px;
	height:60px;
	width:70%;
		...
		<div id="mainBg">
			<div id="mainPanel">
				...
				<div id="right">
					...
					<form name="loginForm" action="<%=path%>/login" method="post" style="
					...
					<div id="user-password">
						...
						<!-- <span class="input"> -->管理员
						<input style="font-size: 10px;" type="radio" name="type" class="form-input" value="1">
							用户<input type="radio" name="type" class="form-input" value="0">
						<!-- </span> -->
					</div>
					<div id="button-group">
