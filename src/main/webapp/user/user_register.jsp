...
#user-name,#user-password,#button-group{ padding: 0px 0;}
#button-group{
	margin-top:10px;
	height:60px;
	width:70%;
...
<div id="wrapper">
	<div id="header">
		<div id="logo">
			<img alt="智能锁" src="<%=path %>/images/lock.png" />
		</div>
		<div id="heading">
		...
		<div id="mainBg">
			<div id="mainPanel">
				...
				<div id="right">
					...
					<form name="loginForm" action="<%=path%>/pcUser/registerUser" method="post" style="
					width: 300px; height: 400px; z-index: 10000; margin: 0 auto;">
					<!-- start of login form -->
					<!-- <div id="welcome">
					...
					<div id="user-name">
						...
						<span><input type="text" name="realname" class="form-input"></span>
					</div>
					...
					<div id="user-name">
						...
						<span><input type="text" name="gender" class="form-input"></span>
					</div>
					<div id="user-name">
						<span class="item">年&nbsp;龄:</span>
						<span><input type="text" name="age" class="form-input"></span>
					</div>
					<div id="user-name">
					...
					<div id="user-name">
						<span class="item">职&nbsp;位:</span>
						<span><input type="text" name="username" class="form-input"></span>
					</div>
					<!-- <div id="user-name">
						<span class="item">工号:</span>
						<span><input type="text" name="jobnumber" class="form-input"></span>
					</div> -->
					<div id="user-name">
						<span class="item">电压:</span>
						<span><input type="text" name="voltage" class="form-input"></span>
					</div>
					<div id="user-name">
						<span class="item">变电站:</span>
						<span><input type="text" name="username" class="form-input"></span>
					</div>
					<div id="button-group">
					...
					<!-- <div id="user-name">
						...
						<span><input type="text" name="" class="form-input"></span>
					</div> -->
